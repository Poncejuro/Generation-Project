...
export const ContactForm = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_qulhdg4', 'template_vjgzmdu', form.current, 'aNsr8PVLj5pQYRcSE')
      .then((response) => {
  ...
  const mostrarAlerta = (exito) => {
    Swal.fire({
      ...
      text: exito ? 'El correo ha sido enviado correctamente.' : 'Hubo un error al enviar el correo.',
        ...
        <div className="col-md-6">
          <form ref={form} onSubmit={sendEmail} className="form">
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control" name="user_tel" required />
              </div>
              <div className="mb-3">
